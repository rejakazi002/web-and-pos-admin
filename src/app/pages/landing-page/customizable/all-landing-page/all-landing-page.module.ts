...
import { AllLandingPageRoutingModule } from './all-landing-page-routing.module';
...
@NgModule({
  declarations: [
    AllLandingPageComponent
  ],
  imports: [
    CommonModule,
    AllLandingPageRoutingModule,
    DaysRemainingPipe,
    FormsModule,
    GalleryImageViewerComponent,
    LimitTextPipe,
...
export class AllLandingPageModule { }
