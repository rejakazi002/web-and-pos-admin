...
import { AllReadyLandingPageRoutingModule } from './all-ready-landing-page-routing.module';
...
@NgModule({
  declarations: [
    AllReadyLandingPageComponent
  ],
  imports: [
    CommonModule,
    AllReadyLandingPageRoutingModule,
    DaysRemainingPipe,
    FormsModule,
    GalleryImageViewerComponent,
    LimitTextPipe,
...
export class AllReadyLandingPageModule { }
