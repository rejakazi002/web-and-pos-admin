...
import { AllSkinConcernRoutingModule } from './all-skin-concern-routing.module';
...
@NgModule({
  declarations: [
    AllSkinConcernComponent
  ],
    imports: [
        CommonModule,
        AllSkinConcernRoutingModule,
        DaysRemainingPipe,
        FormsModule,
        GalleryImageViewerComponent,
        LimitTextPipe,
...
export class AllSkinConcernModule { }
