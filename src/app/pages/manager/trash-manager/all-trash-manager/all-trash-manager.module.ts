...
import { AllTrashManagerRoutingModule } from './all-trash-manager-routing.module';
...
@NgModule({
  declarations: [
    AllTrashManagerComponent
  ],
    imports: [
        CommonModule,
        AllTrashManagerRoutingModule,
        FormsModule,
        GalleryImageViewerComponent,
        LimitTextPipe,
        MatButtonModule,
...
export class AllTrashManagerModule { }
