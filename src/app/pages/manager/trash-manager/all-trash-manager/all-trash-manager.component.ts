...
@Component({
  selector: 'app-all-trash-manager',
  templateUrl: './all-trash-manager.component.html',
  styleUrl: './all-trash-manager.component.scss'
})
export class AllTrashManagerComponent extends DataTableSelectionBase(Component) implements AfterViewInit, OnDestroy {
  ...
  private setPageData(): void {
    this.title.setTitle('Trash Manager');
    this.pageDataService.setPageData({
      title: 'Trash Manager',
      navArray: [
        {name: 'Dashboard', url: `/dashboard`},
        {name: 'Trash Manager', url: null},
      ]
    })
  }
