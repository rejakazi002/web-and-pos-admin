...
@Component({
  ...
  styleUrl: './all-subscription.component.scss'
})
export class AllSubscriptionComponent extends DataTableSelectionBase(Component) implements AfterViewInit, OnDestroy {
  ...
  private setPageData(): void {
    this.title.setTitle('All Subscription');
    this.pageDataService.setPageData({
      title: 'All Subscription',
      navArray: [
        {name: 'Dashboard', url: `/dashboard`},
        {name: 'All Subscription', url: null},
      ]
    })
  }
  ...
  private getAllSubscription() {
    ...
    const subscription = this.subscriptionDataService.getAllSubscription(filterData, this.searchQuery)
      .subscribe({
        next: res => {
