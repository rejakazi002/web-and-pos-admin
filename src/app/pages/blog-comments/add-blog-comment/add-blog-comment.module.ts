...
import { AddBlogCommentRoutingModule } from './add-blog-comment-routing.module';
...
@NgModule({
  declarations: [
    AddBlogCommentComponent
  ],
  imports: [
    CommonModule,
    AddBlogCommentRoutingModule,
    DigitOnlyModule,
    GalleryImagePickerComponent,
    MatButtonModule,
    MatCheckboxModule,
...
export class AddBlogCommentModule { }
