...
import { AllBlogCommentRoutingModule } from './all-blog-comment-routing.module';
...
@NgModule({
  declarations: [
    AllBlogCommentComponent
  ],
  imports: [
    CommonModule,
    AllBlogCommentRoutingModule,
    DaysRemainingPipe,
    FormsModule,
    GalleryImageViewerComponent,
    LimitTextPipe,
...
export class AllBlogCommentModule { }
