...
export class SkinConcernComponent implements OnInit{
  ...
  constructor(
    public dialogRef: MatDialogRef<SkinConcernComponent>,
  ...
  private addSkinConcern() {
    this.subDataOne = this.skinConcernService.addSkinConcern(this.dataForm.value)
      .subscribe({
        next: (res => {
          if (res.success) {
