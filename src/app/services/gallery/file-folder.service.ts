...
export class FileFolderService {
  ...
  getAllFileFolders(filterData: FilterData, searchQuery?: string) {
    ...
    return this.httpClient.post<{ data: FileFolder[], count: number, success: boolean }>(API_BRAND + 'get-all-by-shop', filterData, {params});
  }
  ...
  deleteMultipleFileFolderById(ids: string[]) {
    return this.httpClient.post<ResponsePayload>(API_BRAND + 'delete-multiple-by-vendor', {ids: ids});
  }
