...
export class GalleryService {
  ...
  insertManyGallery(data: Gallery[], option?: any) {
    ...
    return this.httpClient.post<ResponsePayload>
    (API_BRAND + 'insert-many-by-shop', mData);
  }
  ...
  getAllGalleries(filterData: FilterData, searchQuery?: string) {
    ...
    return this.httpClient.post<{ data: Gallery[], count: number, success: boolean,maxLimit:any }>(API_BRAND + 'get-all-by-shop', filterData, {params});
  }
  ...
  updateGalleryById(id: string, data: Gallery) {
    return this.httpClient.put<{ message: string, success: boolean }>(API_BRAND + 'update-by-vendor/' + id, data);
  }

  updateMultipleGalleryById(ids: string[], data: Gallery) {
    const mData = {...{ids: ids}, ...data}
    return this.httpClient.put<ResponsePayload>(API_BRAND + 'update-multiple-by-vendor', mData);
  }

  deleteGalleryById(id: string) {
    return this.httpClient.delete<ResponsePayload>(API_BRAND + 'delete-by-vendor/' + id);
  }

  deleteMultipleGalleryById(ids: string[]) {
    return this.httpClient.post<ResponsePayload>(API_BRAND + 'delete-multiple-by-shop', {ids: ids});
  }
