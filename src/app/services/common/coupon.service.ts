...
export class CouponService {
  ...
  getAllCoupons(filterData: FilterData, searchQuery?: string) {
    ...
    return this.httpClient.post<{ data: Coupon[], count: number, success: boolean }>(API_TAG + 'get-all-by-shop', filterData, {params});
  }
  ...
  getCouponById(id: string, select?: string) {
    ...
    return this.httpClient.get<{ data: Coupon, message: string, success: boolean }>(API_TAG +'get-by-id/'+ id, {params});
  }
