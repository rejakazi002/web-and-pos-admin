...
export class PromoOfferService {
  ...
  getAllPromoOffers(filterData: FilterData, searchQuery?: string) {
    ...
    return this.httpClient.post<{ data: PromoOffer[], count: number, success: boolean }>(API_BEST_DEAL + 'get-all-by-shop', filterData, {params});
  }
  ...
  getPromoOfferById(id: string, select?: string) {
    ...
    return this.httpClient.get<{ data: PromoOffer, message: string, success: boolean }>(API_BEST_DEAL +'get-by-id/'+ id, {params});
  }
